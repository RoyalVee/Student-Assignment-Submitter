...
import com.tech.royal_vee.myapplication.adapter.NoteRecylerViewAdapter
import com.tech.royal_vee.myapplication.model.Note
import kotlinx.android.synthetic.main.activity_mainsec.*


class MainsecActivity : AppCompatActivity() {


    private val TAG = "MainActivity"

  private var mAdapter: NoteRecylerViewAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firestoreListener = firestoreDB!!.collection("notes")
                .addSnapshotListener(EventListener { documentSnapshots, e ->
                    ...
                    mAdapter = NoteRecylerViewAdapter(notesList, applicationContext, firestoreDB!!)
